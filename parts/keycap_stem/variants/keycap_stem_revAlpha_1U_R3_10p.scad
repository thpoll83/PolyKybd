// PolyKybd keycap stem -- curved profile, row 3 (flat, no lift), 1U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U_R3_10p.stl (the .stl name matches this filename).
