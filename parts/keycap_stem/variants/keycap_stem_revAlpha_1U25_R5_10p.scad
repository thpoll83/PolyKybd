// PolyKybd keycap stem -- curved profile, row 5 (furthest, most tilt and lift), 1.25U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U25_R5_10p.stl (the .stl name matches this filename).
