// PolyKybd keycap stem -- stepped profile, row 5, 1U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U_S5_10p.stl (the .stl name matches this filename).
