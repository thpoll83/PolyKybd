// PolyKybd keycap stem -- curved profile, row 2, 1U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U_R2_10p.stl (the .stl name matches this filename).
