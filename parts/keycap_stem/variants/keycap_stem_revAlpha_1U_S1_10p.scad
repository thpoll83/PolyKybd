// PolyKybd keycap stem -- stepped profile, row 1, 1U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U_S1_10p.stl (the .stl name matches this filename).
