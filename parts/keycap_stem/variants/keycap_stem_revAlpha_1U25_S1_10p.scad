// PolyKybd keycap stem -- stepped profile, row 1, 1.25U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U25_S1_10p.stl (the .stl name matches this filename).
...
// S1 and R1 are deliberately the SAME geometry (angle 5, extra_len 0.5) and
