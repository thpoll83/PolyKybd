// PolyKybd keycap stem -- stepped profile, rows 2-4, 1.25U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U25_S_10p.stl (the .stl name matches this filename).
