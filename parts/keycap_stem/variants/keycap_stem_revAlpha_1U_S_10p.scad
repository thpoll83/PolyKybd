// PolyKybd keycap stem -- stepped profile, rows 2-4, 1U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U_S_10p.stl (the .stl name matches this filename).
