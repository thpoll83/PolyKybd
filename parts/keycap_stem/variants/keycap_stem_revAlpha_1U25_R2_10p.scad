// PolyKybd keycap stem -- curved profile, row 2, 1.25U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U25_R2_10p.stl (the .stl name matches this filename).
...
ten_connected_pieces_1U25(angle = -5, extra_len = 1, txt = str("R2   ", revision));
