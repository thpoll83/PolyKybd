// PolyKybd keycap stem -- curved profile, row 4, 1U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U_R4_10p.stl (the .stl name matches this filename).
