// PolyKybd keycap stem -- curved profile, row 1 (closest to the user), 1.25U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U25_R1_10p.stl (the .stl name matches this filename).
