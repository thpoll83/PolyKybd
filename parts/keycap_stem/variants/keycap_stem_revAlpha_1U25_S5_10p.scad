// PolyKybd keycap stem -- stepped profile, row 5, 1.25U, 10 pieces per plate.
//
...
// parts/export/keycap_stem/keycap_stem_revAlpha_1U25_S5_10p.stl (the .stl name matches this filename).
