...
rotated — and emits parts/diffuser/diffuser_frame_<side>.scad.
...
re-modelled here: the generated file calls diffuser() from parts/diffuser/diffuser.scad.
...
def build(side='left'):
    ...
    # cap.  parts/diffuser/diffuser.scad builds that cap as
...
//  Re-run:  python3 parts/diffuser/gen_diffuser_frame.py {side}
//
...
if __name__ == '__main__':
    ...
    ap.add_argument('--out-dir', default=os.path.join(REPO, 'parts', 'diffuser'))
    args = ap.parse_args()
    left = None
