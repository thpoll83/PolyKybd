...
//  Re-run:  python3 parts/diffuser/gen_diffuser_frame.py left
//
...
module diffuser_frame_left_revision() {
    translate([-37.623, 24.026, -web_t])
        linear_extrude(0.15)
            rotate(90) mirror([1, 0, 0])
                text("L r1.1", size = 1.0, font = "Arial:style=Bold",
